defmodule MeteorWeb.Components.Typography do
  ...
  def header(assigns) do
    ~H"""
    <header class={["flex flex-col gap-2", @alignment, @class]}>
  ...
  defp heading_classes("h1"), do: "text-3xl font-bold"
  defp heading_classes("h2"), do: "text-2xl font-semibold"
  defp heading_classes("h3"), do: "text-xl font-semibold"
  defp heading_classes("h4"), do: "text-lg font-semibold"
  defp heading_classes("h5"), do: "text-lg font-normal text-gray-400"
end
